...
class Pagination:
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        total = self._query_count() if count else None
    ...
    def first(self) -> int:
        ...
        .. versionadded:: 3.0
        """
        return 0 if len(self.items) == 0 else (self.page - 1) * self.per_page + 1
    ...
    def prev_num(self) -> int | None:
        ...
        return None if not self.has_prev else self.page - 1
    ...
    def next_num(self) -> int | None:
        ...
        return None if not self.has_next else self.page + 1
