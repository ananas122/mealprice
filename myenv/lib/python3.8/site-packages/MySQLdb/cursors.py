...
class BaseCursor:
    ...
    def execute(self, query, args=None):
        ...
        return self._query(mogrified_query)
    ...
    def _fetch_row(self, size=1):
        return self._result.fetch_row(size, self._fetch_type) if self._result else ()
...
class CursorStoreResultMixIn:
    ...
    def scroll(self, value, mode="relative"):
        ...
        if mode == "relative":
            ...
            raise ProgrammingError(f"unknown scroll mode {repr(mode)}")
