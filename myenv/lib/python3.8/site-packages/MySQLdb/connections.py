...
def numeric_part(s):
    ...
    return int(m.group(1)) if (m := re_numeric_part.match(s)) else None
...
class Connection(_mysql.connection):
    ...
    def __init__(self, *args, **kwargs):
        ...
        conv2 = {
            k: v[:] if isinstance(k, int) and isinstance(v, list) else v
    ...
    def _bytes_literal(self, bs):
        ...
        return b"_binary" + x if self._binary_prefix else x
    ...
    def literal(self, o):
        ...
        elif isinstance(o, (bytearray, bytes)):
    ...
    def set_sql_mode(self, sql_mode):
        ...
        self.query(f"SET SESSION sql_mode='{sql_mode}'")
        self.store_result()
